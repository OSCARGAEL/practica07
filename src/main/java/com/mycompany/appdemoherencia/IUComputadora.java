...
public class IUComputadora extends JPanel {
    ...
    public IUComputadora(String imagePath, Computadora computadora) {
        this.computadora = computadora;
        try {
            // Cargar la imagen desde el archivo PNG
            image = ImageIO.read(new File("computadora.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                System.out.println("Computadora: "+computadora.toString());
            }
        });
    }
